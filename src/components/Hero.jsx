...
const socialLinkStyles = "flex size-12 items-center justify-center rounded-full border border-transparent text-zinc-600 transition-[background-color,border-color,box-shadow,color] duration-300 supports-hover:border-zinc-200 supports-hover:bg-white/80 supports-hover:text-zinc-900 supports-hover:shadow-sm active:border-zinc-200 active:bg-white/90 focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-600/25 dark:text-zinc-400 dark:supports-hover:border-zinc-700 dark:supports-hover:bg-zinc-800/80 dark:supports-hover:text-zinc-100 dark:active:border-zinc-700 dark:active:bg-zinc-800";
