...
export default function AboutMe() {
  return (
    <div className="mb-10">
      ...
      <motion.div
        className="rounded-lg border border-zinc-200 bg-[#FFFCF6] p-5 shadow-sm transition-colors duration-300 md:p-8 dark:border-zinc-700 dark:bg-[#242428]"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
      >
        <p className="text-md py-2 leading-8 text-zinc-700 dark:text-zinc-300">
          Hi, I am Terence Ye. A <span className="font-medium text-teal-700 dark:text-teal-400">Software Engineer</span> at{" "}
          <a
          ...
          With over <span className="font-medium text-teal-700 dark:text-teal-400">6+ years of experience</span>,
          I&apos;ve leveraged my <span className="font-medium text-teal-700 dark:text-teal-400">full-stack</span>  
