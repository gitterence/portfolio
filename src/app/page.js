        ...
        >
          ...
          <section>
            ...
            <div className="lg:flex gap-10 lg:justify-center">
              {/*  Card FE  */}
              <div className="max-w-sm bg-gray-50/25 text-center shadow-lg p-10 rounded-xl my-10 dark:bg-gray-700" style={{ minWidth: '320px' }}>
          ...
          <section>
            ...
            <div className="flex justify-center">
              ...
              >
                ...
                >
                  {/*  Project Focus Time  */}
                  <motion.div className="max-w-sm m-5 rounded-xl overflow-hidden shadow-lg dark:bg-gray-700" style={{ minWidth: '320px' }}>
                    <Image
                      src={focusTimer}
                  ...
                  {/*  Project Portfolio  */}
                  <motion.div className="min-w-18 max-w-sm m-5 rounded-xl overflow-hidden shadow-lg dark:bg-gray-700" style={{ minWidth: '320px' }}>
                    {darkMode ? (
                      <Image
                        src={brightPortfolio}
                        className="w-full h-60 object-cover pointer-events-none"
